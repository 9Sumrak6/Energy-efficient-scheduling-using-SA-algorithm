...
if __name__ == "__main__":
    ...
    for p_n in proc_num:
        ...
        for j_n in job_num:
            ...
            path_res = "Output/fork_mpi/10/boltz/" + file_name + ".txt"
            ...
            y_res_abs[p_n].append(float(res))
    ...
    for i in x:
        ...
        plt.legend()
        plt.savefig(f'Graphics/procs/{i}.png', bbox_inches='tight')
    ...
    for i in x:
        ...
        plt.legend()
        plt.savefig(f'Graphics/jobs/{i}.png', bbox_inches='tight')